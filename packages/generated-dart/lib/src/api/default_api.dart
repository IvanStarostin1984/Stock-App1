...
import 'package:openapi/src/model/news_article.dart';
...
class DefaultApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<NewsArticle>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<NewsArticle>>> newsGet({ 
    ...
    BuiltList<NewsArticle>? _responseData;
    ...
    return Response<BuiltList<NewsArticle>>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Quote>> quoteGet({ 
    required String symbol,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,

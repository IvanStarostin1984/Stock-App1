...
1	openapi.yaml bundleMarketstack + Exchangerate.host + NewsData	• Inside /spec add openapi.yaml that combines the three public files.• Add an npm script gen:all that runs openapi-generator-cli v2.20.20 and drops code into /generated (npm pkg set scripts.gen:all="openapi-generator-cli generate -i openapi.yaml -g typescript-axios -o generated").• Run npx @redocly/openapi-cli lint until it reports 0 problems.	Dev A	openapi-generator-cli v2.20.2	shared-contracts /spec	npm run gen:all	spec/openapi.spec.test.ts	–	–	S-01 / S-02 / S-03	MVP
